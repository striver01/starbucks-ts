...
import GetStartStep from "./GetStartStep";
import GreenLink from "./GreenLink";
import FavScore from "./FavScore";
...
import Favsection2 from "./Favsection2";
import Extensions2 from "./Extensions2";
interface Props {}
...
const App: React.FC<Props> = (props) => {
  return (
    <div className="mb-10">
      ...
      <Herosection />
      <HeroSection2 />
      <Getstart title="Getting started is easy">
        Earn Stars and get rewarded in a few easy steps.
      </Getstart>
      <div className="mt-6 md:mx-10 md:flex md:text-center md:items-start">
        <GetStartStep link="bg-gs1" title="Download the Starbucks® app">
        ...
        <GetStartStep link="bg-gs2" title="Order and pay how you’d like">
        ...
        <GetStartStep link="bg-gs3" title="Earn Stars, get Rewards">
      ...
      <div className="bg-Primary-300 mt-16">
        <h1 className="text-2xl font-semibold text-center pt-12 pb-4">
          Get your favorites for free
        </h1>
        <div className="flex m-auto max-w-2xl">
          <FavScore act="green">25</FavScore>
          <FavScore act="">50</FavScore>
          <FavScore act="">150</FavScore>
          <FavScore act="">200</FavScore>
          <FavScore act="">400</FavScore>
        </div>
        <Favsection title="Customize your drink">
          Make your drink just right with an extra espresso shot, dairy
          substitute or a dash of your favorite syrup.
        </Favsection>
        <Favsection2 title="Customize your drink">
          Make your drink just right with an extra<br></br> espresso shot, dairy
          substitute or a dash of<br></br> your favorite syrup.
        </Favsection2>
      </div>
      <Getstart title="Endless Extras">
      ...
      <div className="md:flex md:items-start mt-10 md:text-center">
        <Funsection link="bg-Fun1" title="Fun freebies">
          Not only can you earn free coffee, look forward to a birthday treat
          plus coffee and tea refills.<br></br>
          <br></br>
          <GreenLink>Learn More</GreenLink>
        </Funsection>
        <Funsection link="bg-Fun2" title="Order & pay ahead">
          Enjoy the convenience of in-store, curbside or drive-thru pickup at
          select stores.<br></br>
          <br></br>
          <GreenLink>Learn More</GreenLink>
        </Funsection>
        <Funsection link="bg-Fun3" title="Get to free faster">
          Earn Stars even quicker with Bonus Star challenges, Double Star Days
          and exciting games.<br></br>
          <br></br>
          <GreenLink>Learn More</GreenLink>
        </Funsection>
      </div>
      ...
      <Form />
      <div className="bg-Primary-50 text-xxxl py-12 px-6">
        <p className="text-sm">At participating stores. Restrictions apply.</p>
        <div className="md:flex">
          <FootContent title="EARNING STARS">
            Stars cannot be earned on purchases of alcohol, Starbucks Cards or
            Starbucks Card reloads.<br></br>
            <br></br>Earn 1 Star per $1 spent when you scan your member barcode
            in the app, then pay with cash, credit/debit cards or mobile wallets
            at participating stores. You can also earn 1 Star per $1 spent when
            you link a payment method and pay directly through the app.<br></br>
            <br></br>Earn 2 Stars per $1 spent when you load funds and pay with
            your digital Starbucks Card in the app. You can also earn 2 Stars
            per $1 spent when you pay in-person at a participating store with
            your registered physical Starbucks Card or scan your member barcode
            in the app, and then use any physical Starbucks Card (regardless of
            whether it is registered) to complete the purchase.
          </FootContent>
          <FootContent title="TERMS OF USE">
            For full program details visit{" "}
            <GreenLink>starbucks.com/rewards/terms</GreenLink> .<br></br>
            <br></br>* Earn 1 Star per $1 when digitally loading your Starbucks
            Card with your Starbucks® Rewards Visa® Card: See your Card Rewards
            Program Agreement for more details.<br></br>
            <br></br>Starbucks® Rewards benefits are available at participating
            Starbucks stores. Not all stores have the ability to honor Rewards
            at this time. Visit the{" "}
            <GreenLink>Starbucks Store Locator</GreenLink> and search for
            locations honoring “Redeem Rewards”.<br></br>
            <br></br>Deposit and credit card products provided by JPMorgan Chase
            Bank, N.A. Member FDIC
          </FootContent>
        </div>
        <div className="md:flex">
          <FootContent title="BENEFITS">
          ...
          <FootContent title="REDEEMING REWARDS">
      ...
      <div className="border-t-2 border-gray-300 my-8">
        <Extension>About Us</Extension>
        <Extension>Careers</Extension>
        <Extension>Social Impact</Extension>
        <Extension>For Business Partners</Extension>
        <Extension>Order and Pickup</Extension>
        <Extensions2></Extensions2>
      </div>
      <div className="mx-5">
        <div className="opacity-90 border-t-2 border-gray-300 py-8 space-x-4 flex">
          <svg
            className="w-11 h-11 p-1 hover:bg-black hover:bg-opacity-20 rounded-full cursor-pointer"
            viewBox="0 0 24 24"
      ...
      <div className="text-gray-400 text-sm p-5">
